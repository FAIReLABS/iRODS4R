...
Increased write and read operations are an obvious improvement when using rirods 0.2.0 and the iRODS HTTP API has a lot of potential to add even more functionality in the future. Read more about the changes in some of functions interfaces in the [changelog](https://rirods.irods4r.org/news/index.html). Contributions to the package are warmly welcomed. Please report issues and make pull requests in the GitHub repository of [rirods](https://github.com/irods/irods_client_library_rirods).
